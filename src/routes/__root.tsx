...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LuaForge — Roblox Luau AI" },
      { name: "description", content: "AI assistant that writes Roblox Luau scripts, systems, and modules for your games." },
      { property: "og:title", content: "LuaForge — Roblox Luau AI" },
